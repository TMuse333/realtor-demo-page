...
const SellingPage = () => {
    ...
    return (
        <main className="w-screen overflow-x-hidden">
            ...
            description="his interactive slideshow breaks down the home-selling process into clear, actionable steps. Use it to guide your clients through every stage, showcasing your expertise and ensuring a seamless selling experience."
