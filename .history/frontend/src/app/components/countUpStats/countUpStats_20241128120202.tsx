...
const CountUpStats: React.FC<Props> = ({ number1, number2, number3 }) => {
  ...
  return (
    ...
    text-white">
         ...
         my-12">You can display some career stats here</h2>
         <p className="font-semibold px-4">
           This count up component is a great way to use social
           proof and an essential part of making potential clients
           believe that you have a high probability
           of delivering on your offer by demonstrating plenty
         </p>
