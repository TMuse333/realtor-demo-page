...
export const blogData = [
  ...
  export const contactCardData = {
    src: "/agent-profile.jpg", // Replace with the actual profile image path
    ...
    socials: [
      {
        src: "/instagram-icon.png", // Path to Instagram icon
        destination: "https://instagram.com/agentjohndoe", // Replace with actual or placeholder URL
        alt: "Instagram profile",
      },
      {
        src: "/linkedin-icon.png", // Path to LinkedIn icon
