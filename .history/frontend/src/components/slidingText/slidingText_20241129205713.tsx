...
reverse,subText }) => {
    ...
    return (
        <div ref={targetRef}>
            ...
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum facere asperiores error earum dolorum obcaecati odio optio consequatur quisquam atque? Quae quod aliquid expedita tenetur!
            <motion.h2
