...
import {listingImages} from "@/data/data"
...
const PropertyPreview:React.FC<PreviewProps> = ({
    ...
    return (
       ...
       ">
        ...
        height={1300}
        />
        <section className=" bg-gray-300 rounded-2xl
        p-1 mt-[-1rem]">
         ...
         mt-[-1rem]
        justify-between max-w-[250px] mr-auto 
        ">


        <h2 className="mt-4 mb-0 font-black
        text-xl">{address}</h2>
        <p className="text-xl ml-4 my-auto
        font-black self-center mt-5
        text-green-700">{price}</p>
                </section>
        <h2 className="mb-2 font-extrabold
        text-xl text-gray-400">{location}</h2>
        <section className="w-[85vw] max-w-[275px]
        flex justify-around">
          <span>{beds}&nbsp;beds</span>
...
const Property: React.FC<Props> = ({
    ...
    return (
    <section className="bg-gray-200 w-sc">
