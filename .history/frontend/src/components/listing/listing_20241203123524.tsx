...
const Property: React.FC<Props> = ({
    ...
    <section className="">
        ...
        justify-between max-w-[600px] mr-auto ">


        <h1 className="mt-4 mb-2 font-black
        text-2xl">{address}</h1>
        <p className="text-2xl ml-4 mt-2
        font-black self-end">{price}</p>
                </section>
        ...
        bg-gray-600 max-w-[800px] mt-6 rounded-2xl"
        />
        <section className="w-[95vw] max-w-[800px]
        mx-auto">
        ...
        <div className="w-[95vw] mx-auto h-[3px]
        bg-gray-600 mt-6 rounded-2xl max-w-[800px]"
        />
        <section className="">
        <h3 className="font-bold
            my-4 text-xl">
