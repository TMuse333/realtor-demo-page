...
const Footer2:React.FC<props> = ({
  ...
  const bigLinks = [
    ...
    return (
      <footer
      id={id}
      className="w-full bg-red-200 relative flex flex-col items-center justify-center mx-auto my-12 text-black md:w-[90%]"
    >
      ...
      <nav
        ...
        className="w-full flex flex-col items-center justify-center sm:grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 text-center
        md:justify-around"
      >
        {filteredLinks.map((link, index) => (
          <section key={index} className="flex flex-col items-center bg-green-200">
