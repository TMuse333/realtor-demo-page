  ...
  return (
    ...
    >
      <MotionH2
            ...
            className="text-left pl-5 sm:pl-12 pt-5 sm:text-4xl font-semibold  text-3xl
            mb-6 
            pr-3 md:hidden"
      ...
      {customText || (
        ...
        pr-4 md:pr-0'>
          <MotionH2
            ...
            initial={hasAnimation ? 'initial' : ''}
            animate={shouldAnimate ? 'animate' : ''}
            className="hidden md:block text-left pl-5 sm:pl-12 pt-5 sm:text-4xl font-semibold  text-3xl
            pr-3 "
