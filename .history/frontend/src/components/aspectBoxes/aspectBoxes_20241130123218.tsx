...
const AspectElement: React.FC<AspectProps> = ({image,
title, description,alt, index,titleInView,slideComplete}) => {
   ...
   const inView = useInView(componentRef,{
    ...
    return (
        ...
        initial='initial'
        animate={inView  && titleInView && slideComplete && !animationComplete? 'animate' : 'initial'}
