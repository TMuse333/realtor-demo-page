...
">
 This is the contact page
            ...
            text-2xl sm:text-3xl md:text-4xl">Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias nemo distinctio iste eaque laudantium vel itaque totam error ullam optio!</h2>

            <p className="text-white px-4 mb-2">
           Lorem ipsum dolor sit amet consectetur, adipisicing elit. Doloribus ullam nihil voluptates? Vel, eveniet. Praesentium cupiditate quaerat porro necessitatibus qui?
            </p>
